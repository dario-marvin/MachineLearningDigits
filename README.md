...
In the near future we plan to continue using this approach on more and more complicated data, such as [single badly scanned letters of the alphabet](https://github.com/dario-marvin/MachineLearningLetters), and later complete words extracted from a real scanned book.
